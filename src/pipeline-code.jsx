...
const INTEGRATIONS_META = [
  ...
  { key: "unipile", label: "Unipile", icon: "💼", desc: "LinkedIn campaigns & actions — execute outreach on LinkedIn (not used in lead enrichment waterfall)", category: "enrichment", orderTypes: [], credentialFields: [{ name: "account_id", label: "Account ID", type: "text" }, { name: "access_token", label: "Access Token", type: "password" }, { name: "dsn", label: "DSN", type: "text", placeholder: "e.g. [REDACTED]" }], connectEndpoint: "/unipile/connect" },
  ...
  { key: "millionverifier", label: "MillionVerifier", icon: "✅", desc: "Email verification & validation — fast real-time API", category: "enrichment", orderTypes: ["lead_enrichment"], costLabel: "~$0.0005/verify", costTier: 1, credentialFields: [{ name: "api_key", label: "API Key", type: "password" }], connectEndpoint: "/millionverifier/connect" },
